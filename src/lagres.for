...
C     YLRPD(NLR,KLR,M)=(YTMP-YINIT)/TIDALP
      ...
      END DO
C
      RTMP=1./FLOAT(MLRPDRT)
      DO KLR=1,KC
      DO NLR=1,NLRPD
      XLRPD(NLR,KLR,MLRAVG)=RTMP*XLRPD(NLR,KLR,MLRAVG)
      YLRPD(NLR,KLR,MLRAVG)=RTMP*YLRPD(NLR,KLR,MLRAVG)
      ZLRPD(NLR,KLR,MLRAVG)=RTMP*ZLRPD(NLR,KLR,MLRAVG)
      END DO
      END DO
C
      CALL LVELPLTH
