...
C
      ...
      DO MLTM=1,1
        IF (MTMSRC(MLTM).EQ.1) THEN
          IF(ISTRAN(1).GE.1) THEN
            ...
            OPEN(511,FILE=FNSAL(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          IF (ISTRAN(2).GE.1) THEN
            ...
            OPEN(512,FILE=FNTEM(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          IF (ISTRAN(3).GE.1) THEN
            ...
            OPEN(513,FILE=FNDYE(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          IF (ISTRAN(4).GE.1) THEN
            ...
            OPEN(514,FILE=FNSFL(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          IF (ISTRAN(6).GE.1) THEN
            ...
            OPEN(515,FILE=FNSED(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          IF (ISTRAN(7).GE.1) THEN
            ...
            OPEN(516,FILE=FNSND(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          IF (ISTRAN(5).GE.1) THEN
            ...
            OPEN(517,FILE=FNTOX(MLTM,1),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRA(MLTM).EQ.1) THEN
          ...
          OPEN(518,FILE=FNAVV(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          OPEN(519,FILE=FNAVB(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRP(MLTM).EQ.1) THEN
          ...
          OPEN(520,FILE=FNSEL(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRUE(MLTM).EQ.1) THEN
          ...
          OPEN(521,FILE=FNUVE(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRUT(MLTM).EQ.1) THEN
          ...
          OPEN(522,FILE=FNUVT(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRU(MLTM).EQ.1) THEN
          ...
          OPEN(523,FILE=FNU3D(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
          ...
          OPEN(524,FILE=FNV3D(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRQE(MLTM).EQ.1) THEN
          ...
          OPEN(525,FILE=FNQQE(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
     ...
     &       form='unformatted')
        ...
        IF (MTMSRQ(MLTM).EQ.1) THEN
          ...
          OPEN(526,FILE=FNQ3D(MLTM),STATUS='UNKNOWN',
     &       form='unformatted')
